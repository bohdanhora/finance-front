...
const buttonVariants = cva(
    "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
    {
        variants: {
            variant: {
                default: "bg-gray-500 dark:bg-indigo-600 text-white hover:bg-gray-500/90 dark:hover:bg-indigo-600/90",
                destructive: "bg-red-600 text-white hover:bg-red-700 dark:bg-red-500",
                outline:
                    "border border-gray-500 h-9 text-gray-800 bg-transparent rounded-full hover:bg-gray-500 hover:text-white dark:border-indigo-400 dark:text-indigo-400 dark:hover:bg-indigo-400 dark:hover:text-black",
                secondary:
